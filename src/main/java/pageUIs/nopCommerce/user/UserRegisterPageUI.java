...
public class UserRegisterPageUI {
    ...
    public static final String WRONG_EMAIL_MESSAGE = "xpath=//div[contains(@class,'message-error')]";
    public static final String REGISTER_SUCCESS_MESSAGE = "xpath=//div[@class='result']";
    public static final String EMAIL_EXIST_MESSAGE = "xpath=//div[contains(@class,'message-error')]";
